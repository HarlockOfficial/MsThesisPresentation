...
\usepackage{graphicx}
\usepackage{tikz}
\usetikzlibrary{calc, decorations.fractals, positioning, 
arrows.meta, decorations.pathreplacing, shapes.geometric}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Beamer Layout %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\author[shortname]{
    ...
    {\textbf{Supervisor:}~\textit{Prof.~Michele Loreti\\}}
    {\textbf{Supervisor:}~\textit{Prof.~Hannes H\"ogni Vilhj\'almson\\}}
    {\textbf{Co-Supervisor:}~\textit{Prof.~Michela Quadrini\\}}
...
\input{sections/conclusion/conclusion_and_future}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
